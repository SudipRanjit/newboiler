...
class CategoryController extends Controller
{
  ...
  public function index()
  {
    ...
    $categories = $this->category->paginateAllWithCondition(["type" => "Category"], "id", "desc", 40);
  ...
  {
    $this->authorize('view', Category::class);
    $categories = $this->category->searchCategoryWithMultipleCondition(["type" => "Category"] ,$request->search_txt, "id", "desc", 40);
  ...
  public function create()
  {
    ...
    $categories = $this->category->getWithCondition(['publish' => 1, 'parent' => 0, 'type' => 'Category'])->pluck('category', 'id');
  ...
  public function delete(Category $category)
  {
    ...
    try {
      ...
      return redirect()->route('cms::categories.index')
        ->with('error', 'Filed to delete category. '.$e->getMessage())
        ->withInput();
    }
  }
