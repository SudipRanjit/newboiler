...
<div class="content-wrapper"> 
  ...
  <div class="content-header sty-one">
    <h1>Add Radiator Price</h1>
    <ol class="breadcrumb">
      <li><a href="{!! route('cms::dashboard') !!}">Dashboard</a></li>
      <li><a href="{!! route('cms::radiators.index') !!}"><i class="fa fa-angle-right"></i> Radiator Prices</a></li>
      <li><i class="fa fa-angle-right"></i> Add Radiator Price</li>
    </ol>
  </div>

  <div class="content"> 
    {!! Form::open(['route' => 'cms::radiator_prices.store','files'=>true, 'id' => 'post_form']) !!}
    <div class="row">
...
$("#radiator_type_id, #radiator_height_id, #radiator_length_id").select2({
    tags: true,
    width: '100%'
});
