...
<div class="content-wrapper"> 
  ...
  <div class="content-header sty-one">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{!! route('cms::addons.index') !!}"><i class="fa fa-angle-right"></i> Controls</a></li>
      <li><i class="fa fa-angle-right"></i> Edit Control</li>
    </ol>
  </div>

  <div class="content"> 
    {!! Form::model($addon,['route' => ['cms::addons.update', $addon->id], 'method' => 'patch','files'=>true, 'id' => 'post_form']) !!}
    <div class="row">
      @include('cms.addon.form')
    </div>
    {!! Form::close() !!}
    <!-- /.row -->
  </div>
