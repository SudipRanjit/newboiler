...
<div class="content-wrapper"> 
  ...
  <div class="content-header sty-one">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{!! route('cms::brands.index') !!}"><i class="fa fa-angle-right"></i> Brands</a></li>
      <li><i class="fa fa-angle-right"></i> Add Brand</li>
    </ol>
  </div>

  <div class="content"> 
    {!! Form::open(['route' => 'cms::brands.store','files'=>true]) !!}
    <div class="row">
      @include('cms.brand.form')
    </div>
    {!! Form::close() !!}
    <!-- /.row -->
  </div>
