<div class="row justify-content-center question-wrapper" id="question__8b">
      ...
      <div class="col-lg-4 col-6">
        <div class="option-wrapper q8b" id="q8bo1" alt="question__8b">
          <a href="javascript:void(0)" class="want-radiator-item want-radiator-yes p-4 p-md-5 figure">
            <img class="img-fluid mb-4 option-image" style="width:auto !important" src="<?php echo WEBIFI_NEW_BOILER_IMAGE_PATH . "images/q8b/o1.svg"; ?>" />
      ...
      <div class="col-lg-4 col-6">
        <div class="option-wrapper q8b" id="q8bo2" alt="question__8b">
          <a href="javascript:void(0)" class="want-radiator-item want-radiator-no p-4 p-md-5 figure">
            <img class="img-fluid mb-4 option-image" style="width:auto !important" src="<?php echo WEBIFI_NEW_BOILER_IMAGE_PATH . "images/q8b/o2.svg"; ?>" />
  ...
  <div class="nav-wrapper back__btn" id="back__8b" alt="question__8" cur="question__8b"><i class="fa-solid fa-arrow-left"></i></div>
</div>