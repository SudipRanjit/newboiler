...
<div class="content-wrapper"> 
  ...
  <div class="content-header sty-one">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{!! route('cms::radiators.index') !!}"><i class="fa fa-angle-right"></i> Radiator</a></li>
      <li><i class="fa fa-angle-right"></i> Edit Radiator</li>
    </ol>
  </div>

  <div class="content"> 
    {!! Form::model($radiator,['route' => ['cms::radiators.update', $radiator->id], 'method' => 'patch','files'=>true, 'id' => 'post_form']) !!}
    <div class="row">
      @include('cms.radiator.form')
    </div>
    {!! Form::close() !!}
    <!-- /.row -->
  </div>
