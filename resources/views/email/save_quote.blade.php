                                                ...
                                                <tr>
                                                  ...
                                                  <td align="center">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                      style="font-family:'Raleway',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;"><span>Quote Reference<br><small>{{$quote["id"]}}</small></span></a>
                          ...
                          <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                              <td align="center"
                                ...
                                <div>
                                  Your <strong>Gasking</strong> quote
                                </div>
                                <div style="font-size:20px;">
                                  Your price is locked in for 30 days.
                                </div>
                                @php 
                                $today = new DateTime();
                                $date = $today->modify('+30 day');
                                @endphp
                                <div style="font-size:14px;">
                                  Order before <span style="color:#efff00; font-size: 20px;">11:59pm</span> on <span style="color:#efff00; font-size: 20px;">{{$date->format('d M Y')}}</span>
                                </div>
