...
<div class="content-wrapper"> 
  ...
  <div class="content-header sty-one">
    <h1>Edit Radiator Price</h1>
    <ol class="breadcrumb">
      <li><a href="{!! route('cms::dashboard') !!}">Dashboard</a></li>
      <li><a href="{!! route('cms::radiator_prices.index') !!}"><i class="fa fa-angle-right"></i> Radiator Price</a></li>
      <li><i class="fa fa-angle-right"></i> Edit Radiator Price</li>
    </ol>
  </div>

  <div class="content"> 
    {!! Form::model($radiator_price,['route' => ['cms::radiator_prices.update', $radiator_price->id], 'method' => 'patch','files'=>true, 'id' => 'post_form']) !!}
    <div class="row">
      @include('cms.radiator_price.form')
    </div>
    {!! Form::close() !!}
    <!-- /.row -->
  </div>
...
$("#radiator_types, #radiator_heights, #radiator_lengths").select2({
    tags: true,
    width: '100%'
});
