...
<div class="content-wrapper"> 
  ...
  <div class="content-header sty-one">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{!! route('cms::boilers.index') !!}"><i class="fa fa-angle-right"></i> Boilers</a></li>
      <li><i class="fa fa-angle-right"></i> Add Boiler</li>
    </ol>
  </div>

  <div class="content"> 
    {!! Form::open(['route' => 'cms::boilers.store','files'=>true, 'id' => 'post_form']) !!}
    <div class="row">
