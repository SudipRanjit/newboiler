...
<div class="content-wrapper"> 
  ...
  <div class="content-header sty-one">
    <h1>Edit Smart Device</h1>
    <ol class="breadcrumb">
      <li><a href="{!! route('cms::dashboard') !!}">Dashboard</a></li>
      <li><a href="{!! route('cms::devices.index') !!}"><i class="fa fa-angle-right"></i> Smart Devices</a></li>
      <li><i class="fa fa-angle-right"></i> Edit Smart Device</li>
    </ol>
  </div>

  <div class="content"> 
    {!! Form::model($device,['route' => ['cms::devices.update', $device->id], 'method' => 'patch','files'=>true, 'id' => 'post_form']) !!}
    <div class="row">
      @include('cms.device.form')
    </div>
    {!! Form::close() !!}
    <!-- /.row -->
  </div>
...
<script>
  $('#device-name').keyup(function() {
    var title = $('#device-name').val();
