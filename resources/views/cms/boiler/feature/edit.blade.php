...
<div class="content-wrapper"> 
  ...
  <div class="content-header sty-one">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{!! route('cms::boiler.features.index') !!}"><i class="fa fa-angle-right"></i> Boiler Features</a></li>
      <li><i class="fa fa-angle-right"></i> Edit Feature</li>
    </ol>
  </div>

  <div class="content"> 
    {!! Form::model($feature,['route' => ['cms::boiler.features.update', $feature->id], 'method' => 'patch','files'=>true, 'id' => 'post_form']) !!}
    <div class="row">
      @include('cms.boiler.feature.form')
    </div>
    {!! Form::close() !!}
    <!-- /.row -->
  </div>
...
<script>
  $('#addon-name').keyup(function() {
    var title = $('#addon-name').val();
