...
/*===================================================================================
Boiler Features Module
====================================================================================*/

$router->get('features', 'BoilerFeature\BoilerFeatureController@index')->name('boiler.features.index');

$router->get('features/add', 'BoilerFeature\BoilerFeatureController@create')->name('boiler.features.create');

$router->get('features/edit/{feature}', 'BoilerFeature\BoilerFeatureController@edit')->name('boiler.features.edit');

$router->delete('features/delete/{feature}', 'BoilerFeature\BoilerFeatureController@delete')->name('boiler.features.delete');

$router->patch('features/update/{feature}', 'BoilerFeature\BoilerFeatureController@update')->name('boiler.features.update');

$router->post('features/store', 'BoilerFeature\BoilerFeatureController@store')->name('boiler.features.store');

$router->get('features/search', 'BoilerFeature\BoilerFeatureController@search')->name('boiler.features.search');
