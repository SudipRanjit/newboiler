<div class="row justify-content-center question-wrapper" id="question__3a">
  <div class="col-md-8 question">
    <h2 class="text-center mb-4">Roughly how old is your boiler?</h2>
  </div>
  ...
  <div class="nav-wrapper back__btn" id="back__3a" alt="question__3" cur="question__3a"><i class="fa-solid fa-arrow-left"></i></div>
</div>
