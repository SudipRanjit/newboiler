<div class="row justify-content-center question-wrapper" id="question__5b">
  <div class="col-md-8 question">
    <h2 class="text-center mb-4">Do you accept that there may be extra charges for access equipment?</h2>
    <p class="text-center text-black-light mb-5 info__line_2">We will ask for photos after you checkout, and advise you if access equipment is required</p>
  </div>
  ...
  <div class="nav-wrapper back__btn" id="back__5b" alt="question__5a" cur="question__5b"><i class="fa-solid fa-arrow-left"></i></div>
</div>