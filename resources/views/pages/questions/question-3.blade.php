<div class="row justify-content-center question-wrapper" id="question__3">
  ...
  <div class="options want-radiator">
    <div class="row justify-content-center">
      <div class="col-lg-4 col-6">
        <div class="option-wrapper q3" id="q3o1">
          <a href="javascript:void(0)" class="want-radiator-item want-radiator-yes p-4 p-md-5 figure">
            <img class="img-fluid mb-4 option-image" style="width:auto !important" src="<?php echo WEBIFI_NEW_BOILER_IMAGE_PATH . "images/q3/o1.svg"; ?>" />
      ...
      <div class="col-lg-4 col-6">
        <div class="option-wrapper q3" id="q3o2">
          <a href="javascript:void(0)" class="want-radiator-item want-radiator-no p-4 p-md-5 figure">
            <img class="img-fluid mb-4 option-image" style="width:auto !important" src="<?php echo WEBIFI_NEW_BOILER_IMAGE_PATH . "images/q3/o2.svg"; ?>" />
  ...
  <div class="nav-wrapper back__btn" id="back__3" alt="question__2" cur="question__3"><i class="fa-solid fa-arrow-left"></i></div>
</div>
