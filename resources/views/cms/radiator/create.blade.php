...
<div class="content-wrapper"> 
  ...
  <div class="content-header sty-one">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{!! route('cms::radiators.index') !!}"><i class="fa fa-angle-right"></i> Radiators</a></li>
      <li><i class="fa fa-angle-right"></i> Add Radiator</li>
    </ol>
  </div>

  <div class="content"> 
    {!! Form::open(['route' => 'cms::radiators.store','files'=>true, 'id' => 'post_form']) !!}
    <div class="row">
